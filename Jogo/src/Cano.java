public class Cano {
	...
	public void desenha(Tela passaro1){
		passaro1.imagem("flappy.png", 604, 0, 52, 270, 0, x, y-270); // CANO DE CIMA POSICAO
	    passaro1.imagem("flappy.png", 660, 0, 52, 242, 0, x, y+Cano.HOLESIZE); //CANO DE BAIXO POSICAO
	}
  }
